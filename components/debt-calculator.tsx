    ...
    <div className="min-h-screen bg-white dark:bg-black">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Es tomar un nuevo préstamo con mejores condiciones (menor
                  tasa) para cancelar una deuda existente más cara.
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-semibold text-black dark:text-white">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  El Costo Financiero Total incluye la tasa de interés más todos
                  los impuestos argentinos: IVA, Impuesto al Cheque, IIBB,
                  Sellos y tasas municipales.
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-semibold text-black dark:text-white">
                  ¿Siempre conviene refinanciar?
                </h3>
                <p className="text-gray-700 dark:text-gray-300">
                  Conviene cuando la nueva tasa es significativamente menor y el
                  ahorro supera los costos de refinanciamiento (gastos
                  administrativos, seguros, etc.).
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-semibold text-black dark:text-white">
                  ¿Qué gastos tiene refinanciar?
                </h3>
                <p className="text-gray-700 dark:text-gray-300">
                  Pueden incluir gastos administrativos, seguros, tasaciones y
                  comisiones. Estos costos varían según la entidad financiera.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-16">
        <section className="space-y-8 px-6 py-12">
          <h1 className="text-center text-xl font-semibold">¿Cómo funciona el refinanciamiento de deuda?</h1>
          <div className="bg-green-50 dark:bg-green-950 rounded-2xl p-8 border-2 border-green-200 dark:border-green-800 max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  Invertí la diferencia mensual y generá rendimientos
                  adicionales.
                </p>
              </div>
            </div>
        ...
        <section className="space-y-8 px-6">
          <div className="text-center space-y-2 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Ingresa los datos de tu deuda actual y la nueva tasa que puedes
              obtener
            </p>
          </div>
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 max-w-4xl mx-auto">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 mt-4">
                Selecciona solo los impuestos que aplican a tu situación
                específica para obtener un CFT más preciso.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white dark:bg-black rounded-xl p-12 border border-gray-200 dark:border-gray-700 text-center">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-semibold text-black dark:text-white">
                      Calculando tu refinanciamiento
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">
                      Analizando tasas, impuestos argentinos y calculando tu
                      ahorro total...
                    </p>
                  </div>
            ...
            <section className="space-y-8">
              <div className="text-center space-y-2 max-w-4xl mx-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  {formatCurrency(calculations.currentTotalPayment)} vs{" "}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="text-xs text-green-600">
                      {(
                        (calculations.totalSavings /
                          calculations.currentTotalPayment) *
                        100
                      ).toFixed(1)}
                      % menos
                    </div>
                  ...
                  <div className="text-center space-y-2">
                    <div className="text-xl font-bold text-red-600">
                      {calculations.currentCFT.toFixed(1)}% →{" "}
                      {calculations.newCFT.toFixed(1)}%
                    </div>
                    ...
                    <div className="text-xs text-green-600">
                      -
                      {(calculations.currentCFT - calculations.newCFT).toFixed(
                        1
                      )}{" "}
                      puntos
                    </div>
                  ...
                  <div className="text-center space-y-2">
                    <div className="text-xl font-bold text-gray-600">
                      {formatCurrency(
                        calculations.currentTaxes.total -
                          calculations.newTaxes.total
                      )}
                    </div>
              ...
              <div className="bg-white dark:bg-black rounded-xl p-6 border-l-4 border-gray-600 border border-gray-200 dark:border-gray-700 max-w-4xl mx-auto">
                ...
                <div className="text-gray-700 dark:text-gray-300 space-y-3 leading-relaxed">
                  <p>
                    <strong>Por cada peso prestado:</strong> Con la tasa actual
                    pagas $
                    {(
                      calculations.currentTotalPayment / calculations.principal
                    ).toFixed(2)}
                    , con la nueva tasa pagarías $
                    {(
                      calculations.newTotalPayment / calculations.principal
                    ).toFixed(2)}
                  </p>
                  <p>
                    <strong>Intereses totales:</strong> Pasarías de pagar{" "}
                    {formatCurrency(calculations.currentTotalInterest)} a{" "}
                    {formatCurrency(calculations.newTotalInterest)} en intereses
                    puros
                  </p>
                  <p>
                    <strong>Tiempo de recuperación:</strong> El ahorro mensual
                    de {formatCurrency(calculations.monthlySavings)}
        ...
        {showResults && !calculations.isValid && (
          <div className="text-center p-8 bg-white dark:bg-black rounded-xl border-l-4 border-red-600 border border-gray-200 dark:border-gray-700 max-w-4xl mx-auto">
            ...
            <p className="mt-2 text-red-600">
              Por favor, verifica que todos los campos tengan valores válidos
              mayores a cero.
            </p>
          </div>
        )}
